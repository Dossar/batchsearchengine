/*****************************************************
 *
 * File:            autocomplete_songname.js
 * Authors:         Roy Van Liew and Jie Lou
 * Last Modified:
 * Description:     Song title autocomplete feature
 *
 ****************************************************/

function autocompleteSongTitle() {
	...
	const $autoComplete = $('.autocompleteSongTitle');
	...
	$autoComplete.bind('propertychange input focus', function (event) {
		...
		$.ajax({
			...
			type : 'GET',
			url : '/autoCompleteProcessSongName',
			dateType : 'json',
			data : {
